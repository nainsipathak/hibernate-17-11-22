...
public class Main {
	...
	public static void main(String[] args) {
		...
		try {
			...
			Actor a2 = new Actor("Mahesh", "Ghattamaneni", 1975,null);
			
			Actor a3 = new Actor("Ramesh", "Ghattamaneni", 1965,null);
			Actor a4 = new Actor("Yash", "Gowda", 1986,null);
			...
			Genre g2 = new Genre("Historical",null);
			...
			Movie movie = movieRepository.findMovieByName("K.G.F");
